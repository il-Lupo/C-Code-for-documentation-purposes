...
int main(void)
{
	...
	//print_all_characters((unsigned short)32, (unsigned short)256);
	...
	char StringToSplit[] = { "Dies ist ein - Tutorial - von mir." };
	char separators[2] = "-";
	...
	unsigned char oe = 'ö';
	memset(String2, oe, sizeof(unsigned char) * (size_t)3);
	printf("%s\n", String2);
	...
	if (!FileExists("C:/Users/Birger/source/repos/C/Code snippets for documentation purposes/Textdokument.txt"))
	{
		return;
	}
	short NumberOfLinesRead = (short)0;
 	char** StringArray = readAllLines("C:/Users/Birger/source/repos/C/Code snippets for documentation purposes/Textdokument.txt", &NumberOfLinesRead);
	...
	wchar_t* AppPath = ApplicationPath();
	if (AppPath == NULL)
	{
		printf("Zur\x81 \bckgegebener String war NULL.\n");
	}
